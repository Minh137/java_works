...
<div class="container">
	<h1 class="my-5 py-5 text-center">
		select * from bbs_bbs order by num desc  ${limit}, 16;
	</h1>
   <ul class="pagination">
   <!-- 이전그룹 -->
   <c:if test="${paging.startPageOfGroup > 1 }">
     <li class="page-item"><a class="page-link" href="?pg=*">Previous</a></li>
     </c:if>
    ...
    <c:if test="${paging.endPageOfGroup < paging.totalPages}">
     <li class="page-item"><a class="page-link" href="${paging.endPageOfGroup }">Next</a></li>
     </c:if>
   </ul>
</div>
</body>
